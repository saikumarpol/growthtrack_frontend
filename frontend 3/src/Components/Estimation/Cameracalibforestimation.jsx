...
const CameraCalibforestimation = () => {
  ...
  const handleRequestPermission = async () => {
    ...
    try {
      ...
      if (err === 'Gyroscope not detected') {
        ...
        navigate('/image-capture-no-gyro1', { state: { warning: 'Gyroscope not detected. Proceeding without gyroscope.' } });
      } else {
...
export default CameraCalibforestimation;
