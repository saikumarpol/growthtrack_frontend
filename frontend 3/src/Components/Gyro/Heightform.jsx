...
//         const subjectId = id;
//         if (!subjectId) {
//             swal("Error", "No patient ID found in localStorage", "error");
//             return;
//         }
...
//                         setHeight(sortedHeights[0].value || '');
//                     } else {
//                         console.log("No height array, using calculated or original height");
//                         setHeight(data.calculated_height || data.og_height || '');
//                     }
...
//                         setWeight(sortedWeights[0].value || '');
//                     } else {
//                         console.log("No weight array, using calculated or original weight");
//                         setWeight(data.calculated_weight || data.og_weight || '');
//                     }
...
//             const params = {
//                 Bucket: bucketName,
//                 Key: `portfolio1/${imageName}`, // Removed leading slash
//                 Body: imageData,
...
//                     button: "OK",
//                 });
//                 navigate("/subjectlistcards"); // Redirect to /subjectlistcards
//             } else {
...
//             if (heightData.status === 'Success' && weightData.status === 'Success') {
//                 // Redirect to /subjectlistcards without showing success message
...
//                 }
//             } else {
//                 const errorMessage = heightData.status !== 'Success' 
...
//                                 onClick={() => navigate('/inst-estimation', { 
//                                     state: { 
//                                         subjectId: id, 
//                                         subjectName: name, 
//                                         subjectAge: age, 
